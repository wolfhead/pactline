...
func TestCanClaim(t *testing.T) {
	eng := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleEngineer}}
	other := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleEngineer}}
	pm := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSponsor}}
...
func TestCanEditAndNominate(t *testing.T) {
	sponsor := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSponsor}}
	claimer := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleEngineer}}
	steward := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSteward}}
	stranger := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleEngineer}}
	...
	t.Run("CanNominate with nil ClaimedBy", func(t *testing.T) {
		eng := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleEngineer}}
		stwd := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSteward}}
...
func TestCanSetDifficulty(t *testing.T) {
	sponsor := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSponsor}}
	techLead := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleTechLead}}
	sponsorTechLead := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSponsor, userdomain.UserRoleTechLead}}
	steward := userdomain.User{ID: uuid.New(), Roles: []userdomain.UserRole{userdomain.UserRoleSteward}}
