...
func listBounties(t *testing.T, h http.Handler, actor string) []domain.Bounty {
	t.Helper()
	rec := do(t, h, http.MethodGet, "/api/bounties", actor, nil)
...
func TestDraftInvisibleToNonSponsorViaListAndGet(t *testing.T) {
	...
	require.Equal(t, http.StatusNotFound,
		do(t, h, http.MethodGet, "/api/bounties/"+b.ID.String(), engCID, nil).Code,
	...
	require.Equal(t, http.StatusOK,
		do(t, h, http.MethodGet, "/api/bounties/"+b.ID.String(), pmID, nil).Code,
	...
	require.Equal(t, http.StatusOK,
		do(t, h, http.MethodGet, "/api/bounties/"+b.ID.String(), stewardID, nil).Code,
